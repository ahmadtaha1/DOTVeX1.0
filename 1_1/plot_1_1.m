...
% Calls model_1_1.m to solve system and observer dynamics before plotting
...
disp(' ');
disp('Solving ODE...')
[t, z] = ode15s(@model_1_1, tspan, [x0; xhat0], []);  % solving ODE's through ode suit
disp('Done!')     
...
%% Checking converging/diverging plots
threshold = 5;
t_final = find(t==tend);
