...
% Calls model_1_2.m to solve system and observer dynamics before plotting.
...
disp(' ');
disp('Solving ODE...')
[t, z] = ode15s(@model_1_2, tspan, [x0; xhat0], []);  % solving ODE's through ode suit
disp('Done!')     
