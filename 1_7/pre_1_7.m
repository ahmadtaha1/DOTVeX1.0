...
% Calls model_1_7.m to solve system and observer dynamics before plotting
...
x0 = [ -12.4144; 148.9698; 140.9034; 141.7192; 67.1497 ];
x0
...
disp(' ');
disp('Solving ODE...')
[t, z] = ode15s(@model_1_7, tspan, [x0; xhat0], []); %Solving ODE's through ode suit
disp('Done!')     
