function interact_case2()

% This is based on user-defined systems (Loads user defined values)
...
% After end of each observer execution .png file flashes on screen which contain more details of the respective observer 

global p sys

    disp('Loading udef_sys.mat...'), load udef_sys;
